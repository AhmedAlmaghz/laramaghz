...
class ModuleBuilderController extends Controller
{
    ...
    public function index(Module $modules)
    {
        ...
        */
        ...
        return view('laramaghz::admin.generator.index', compact('modules'));
    }
    ...
    public function stepOneView($id = null, Module $module)
    {
        ...
        return view('laramaghz::admin.generator.steps.step-one.index', compact(
            'module'
        ));
    }
    ...
    public function stepTwoView($id, Module $module)
    {
       ...
       */
        ...
        return view('laramaghz::admin.generator.steps.step-two.index', compact(
            'module',
            'migrationTypes',
            'migrationModifiers'
        ));
    ...
    public function stepTwoStore($id, Column $column, StepTwoRequest $request, Module $module)
    {
        ...
        foreach ($request->name as $key => $name) {
            $array = [
                'name' => $name,
                'column' => Str::camel($request->column[$key]),
    ...
    public function stepThreeView($id, Module $module)
    {
        ...
        return view('laramaghz::admin.generator.steps.step-three.index', compact(
            'module',
            'htmlInputType',
            'validationRules'
        ));
    ...
    */
    ...
    public function stepFourView($id, Module $module , Relation $relation)
    {
       ...
       */
        ...
        return view('laramaghz::admin.generator.steps.step-four.index', compact(
            'module',
            'relationType',
            'modules',
            'relations',
    ...
    public function stepFiveView($id ,Module $module)
    {
        ...
        return view('laramaghz::admin.generator.steps.step-five.index', compact(
            'module',
            'arrays',
            'languages'
        ));
