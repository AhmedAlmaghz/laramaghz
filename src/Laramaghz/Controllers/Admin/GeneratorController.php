...
class GeneratorController extends Controller
{
    ...
    {
        Artisan::call('laramaghz:api_request', ['module' => $module->name]);
    }
    ...
    */
    ...
    {
        Artisan::call('laramaghz:api_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:route_front', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:route_api', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:api_resource', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:lang', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:seeder', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:config', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:front_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:admin_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_front_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_admin_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:front_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:admin_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_front_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_admin_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_front_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:view_admin_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:migration', ['module' => $module->name]);
    }
   ...
   */
    ...
    {
        Artisan::call('laramaghz:provider', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:route_admin', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laramaghz:model', ['module' => $module->name]);
    }
