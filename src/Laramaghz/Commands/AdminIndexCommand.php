...
use almaghz\laramaghz\Laramaghz\Traits\AdminFormTrait;
use almaghz\laramaghz\Laramaghz\Traits\AdminIndexTrait;
...
class AdminIndexCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laramaghz:view_admin_index {module}';
